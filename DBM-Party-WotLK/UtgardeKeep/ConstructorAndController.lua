...
function mod:OnCombatStart(delay)
	DBM:FireCustomEvent("DBM_EncounterStart", 524, "Skarvald the Constructor & Dalronn the Controller")
end

function mod:OnCombatEnd(wipe)
	DBM:FireCustomEvent("DBM_EncounterEnd", 524, "Skarvald the Constructor & Dalronn the Controller", wipe)
end
