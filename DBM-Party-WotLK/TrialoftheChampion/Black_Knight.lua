...
local timerCombatStart		= mod:NewTimer(46.5, "TimerCombatStart", 2457)
...
function mod:OnCombatStart(delay)
	DBM:FireCustomEvent("DBM_EncounterStart", 543, "The Black Knight")
	warnedfailed = false
end

function mod:OnCombatEnd(wipe)
	DBM:FireCustomEvent("DBM_EncounterEnd", 543, "The Black Knight", wipe)
end
