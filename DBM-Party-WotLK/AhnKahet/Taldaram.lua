...
local timerEmbrace		= mod:NewTargetTimer(15, 55959)
local timerFlameCD		= mod:NewCDTimer(17, 55959)

function mod:OnCombatStart(delay)
	DBM:FireCustomEvent("DBM_EncounterStart", 581, "Prince Taldaram")
end

function mod:OnCombatEnd(wipe)
	DBM:FireCustomEvent("DBM_EncounterEnd", 581, "Prince Taldaram", wipe)
end
