local mod	= DBM:NewMod("Mimiron", "DBM-Ulduar", 3)
...
function mod:OnCombatStart(delay)
	...
	if (self.Options.SunwellBoost) then
		...
		timerHardmode				= mod:NewTimer(480, "TimerHardmode", 64582)
	end
    phase = 0
    hardmode = false
	is_spinningUp = false
